...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11003 - Pranav$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/Final_recording.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{figs/before_audiofilter}
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{figs/after_audiofilter}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
%
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{2.97684433}y(n - 1) + \brak{3.42230953}y(n - 2) \nonumber \\
	&- \brak{-1.7861066}y(n - 3) + \brak{0.35557738}y(n - 4) \nonumber \\
	&= \brak{9.33\times 10^{-4}}x(n) + \brak{3.73 \times 10^{-3}}x(n - 1) \nonumber \\
	&+ \brak{5.6 \times 10^{-3}}x(n - 2) + \brak{3.73 \times 10^{-3}}x(n - 3) \nonumber \\
	&+ \brak{9.33 \times 10^{-4}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/analog_filt.py\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/ManasVasana/ee1205/blob/main/Audio_filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
